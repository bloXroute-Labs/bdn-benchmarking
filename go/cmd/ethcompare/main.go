	...
	app := &cli.App{
		...
		Commands: []*cli.Command{
			...
			},
			{
				...
				Action: cmpfeeds.NewTxFeedsCompareFiberService().Run,
			},
			{
				Name:  "txsfibergrpc",
				Usage: "compares stream of txs from gateway vs node",
				...
				Action: cmpfeeds.NewTxFeedsCompareFiberGrpcService().Run,
			},
			{
				Name:  "txsmevlink",
				Usage: "compares stream of txs from gateway vs mev link rpc",
				Flags: []cli.Flag{
					flags.Gateway,
					flags.MEVLinkAPIKey,
					flags.TxFeedName,
